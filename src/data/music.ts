...
export const ROOT_NOTES: RootNote[] = [
  ...
  { id: 'db', label: 'C#/Db', displayName: 'Db', pitchClass: 1, letter: 'D', accidental: -1, preferFlats: true },
  { id: 'd', label: 'D', displayName: 'D', pitchClass: 2, letter: 'D', accidental: 0, preferFlats: false },
  { id: 'eb', label: 'D#/Eb', displayName: 'Eb', pitchClass: 3, letter: 'E', accidental: -1, preferFlats: true },
  ...
  { id: 'gb', label: 'F#/Gb', displayName: 'Gb', pitchClass: 6, letter: 'G', accidental: -1, preferFlats: true },
  { id: 'g', label: 'G', displayName: 'G', pitchClass: 7, letter: 'G', accidental: 0, preferFlats: false },
  { id: 'ab', label: 'G#/Ab', displayName: 'Ab', pitchClass: 8, letter: 'A', accidental: -1, preferFlats: true },
  { id: 'a', label: 'A', displayName: 'A', pitchClass: 9, letter: 'A', accidental: 0, preferFlats: false },
  { id: 'bb', label: 'A#/Bb', displayName: 'Bb', pitchClass: 10, letter: 'B', accidental: -1, preferFlats: true },
